...
LowPassFilter::LowPassFilter(float frequency, float Q, uint32_t sampleRate) {
    SetCoefficients(frequency, Q, 0, sampleRate);
}

void LowPassFilter::SetCoefficients(float frequency, float Q, float gain, uint32_t sampleRate) {
